...
public class EmployeeController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('HR', 'CEO') or (hasRole('MANAGER') and @employeeService.isManagerOfEmployee(#id, authentication.principal.id))")
    ...
    // Delete employee (HR and CEO only)
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyRole('HR', 'CEO')")
    ...
    @PreAuthorize("hasAnyRole('CEO', 'HR') or (#username == authentication.principal.username)")
